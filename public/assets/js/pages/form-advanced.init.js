...
!function ($) {
  ...
  const routeListEmployee = $("#routeListEmployee").val()
  ...
  AdvancedForm.prototype.init = function () {
    ...
    $('.select2-ajax-employee').select2({
      ajax: {
        url: routeListEmployee,
        dataType: 'json',
        delay: 250,
        type: 'GET',
        data: function data(params) {
    ...
    function formatRepoEmployee(repo) {
      ...
      var $container = $("<div class='select2-result-repository clearfix'>" + "<div class='select2-result-repository__avatar'><img src='" + repo.photo + "' /></div>" + "<div class='select2-result-repository__meta'>" + "<div class='select2-result-repository__title'></div>" + "<div class='select2-result-repository__description'></div>" + "<div class='select2-result-repository__statistics'>" + "<div class='select2-result-repository__forks'><i class='fa fa-flash'></i> </div>" + "</div>" + "</div>" + "</div>");
      ...
      $container.find(".select2-result-repository__forks").append(repo.email);
      return $container;
    }

    function formatRepoSelectionEmployee(repo) {
