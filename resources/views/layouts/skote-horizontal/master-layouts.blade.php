...
@show
    ...
    <div id="layout-wrapper">
        @include('layouts.skote-horizontal.horizontal')
        <!-- ============================================================== -->
        ...
        <div class="main-content">
            ...
            @include('layouts.skote-horizontal.footer')
        </div>
        <!-- ============================================================== -->
