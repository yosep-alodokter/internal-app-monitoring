...
@section('content')
    ...
    @component('common-components.skote.breadcrumb')
        @slot('title') Edit Device @endslot
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-parsley" id="jq-validation-form-create">
                        <input type="hidden" id="dataId" value="{{ \Crypt::encrypt($iot_device->id) }}"> 
                        <input type="hidden" id="tipeProses" value="update">
                        @csrf
                        <input type="hidden" name="id" id="id">
                        <div class="form-group row mb-3">
                            <label for="example-text-input" class="col-md-2 col-form-label">Device Name<sup class="text-danger">*</sup></label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $iot_device->device_name }}" id="device_name" name="device_name" placeholder="Device Name">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="example-text-input" class="col-md-2 col-form-label">Device Key<sup class="text-danger">*</sup></label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="{{ $iot_device->device_key }}" id="device_key" name="device_key" placeholder="Device Key">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="example-text-input" class="col-md-2 col-form-label">Is Active<sup class="text-danger">*</sup></label>
                            <div class="col-md-10">
                                {!! Form::select('is_active', ["yes" => "yes", "no" => "no"], $iot_device->is_active, ['placeholder' => 'Select', 'class' => 'form-control select2', 'id' => 'is_active', 'name' => 'is_active']) !!}
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="example-text-input" class="col-md-2 col-form-label">Group Site<sup class="text-danger">*</sup></label>
                            <div class="col-md-10">
                                {!! Form::select('group_id', $dataGroupSite, $iot_device->group_id, ['placeholder' => 'Select', 'class' => 'form-control select2', 'id' => 'group_id', 'name' => 'group_id']) !!}
                            </div>
                        </div>

                        <div class="mt-4 float-right">
                            <div class="button-items">
                                <button type="submit" class="btn btn-primary waves-effect waves-light" id="btnSubmitForm">Update</button>
